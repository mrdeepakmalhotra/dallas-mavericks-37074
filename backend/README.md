...
## Project Structure
    ...
    ├── dallas_mavericks_37074  # Django project configurations
...
1. Clone this repo and `cd dallas_mavericks_37074`
...
2. Clone this repo and `cd dallas_mavericks_37074`
